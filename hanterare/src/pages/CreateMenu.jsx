...
const CreateMenu = () => {
  ...
  const handleAddRecipe = () => {
    ...
    weekMenu[day.name] = [...weekMenu[day], addedRecipe];

    setShoppingList(
      summarizeShoppingList([...shoppingList, addedRecipe.ingredients])
    );
          ...
          >
            ...
            <div className="form-element">
              <input
                ...
                onClick={() => {
                  setShoppingList(
                    summarizeShoppingList(shoppingList, ingredients)
                  );
                }}
              />
            </div>
